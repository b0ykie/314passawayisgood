...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2023 at 05:09 PM
...
INSERT INTO `bidding_table` (`id`, `staff_id`, `bidding_status`, `role`, `slot_id`) VALUES
(24, 'vandalim', 'pending', 'chef', '11/11/11'),
(25, 'vandalim', 'approved', 'chef', '22/22/22'),
(26, 'vandalim', 'rejected', 'chef', '33/33/33');
...
INSERT INTO `work_slot` (`slotID`, `ownerID`, `chefSlot`, `cashierSlot`, `waiterSlot`, `slotDate`) VALUES
(1, 'cafeowner', 0, 0, 0, '11/11/11'),
(2, 'cafeowner', 0, 0, 0, '22/22/22'),
(3, 'cafeowner', 0, 0, 0, '33/33/33'),
(4, 'cafeowner2', 0, 0, 0, '88/88/88'),
(5, 'cafeowner2', 0, 0, 0, '99/99/99'),
(7, 'cafeowner2', 0, 0, 0, '10/10/10');

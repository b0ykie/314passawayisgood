<?php
  ...
  require_once 'staffViewPendingBidsController.php';
  $viewPendingBids = new staffViewPendingBidsController();
  ...
  <body>
    ...
    <main>
      ...
      if (isset($_POST['submit'])) {
        ...
        $resultSearch = $viewPendingBids->searchUserPendingBids($username, $userRole, $searchKeyword);

<?php
  ...
  require_once 'staffViewRejectedBidsController.php';
  $viewPendingBids = new staffViewRejectedBidsController();
  ...
  <body>
    ...
    <main>
      ...
      if (isset($_POST['submit'])) {
        ...
        $resultSearch = $viewPendingBids->searchUserRejectedBids($username, $userRole, $searchKeyword);

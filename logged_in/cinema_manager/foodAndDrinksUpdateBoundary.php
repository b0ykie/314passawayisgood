...
<meta charset="UTF-8">
    ...
    <title>Movie Booking System - Update FNB</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">    
            <h1>Update Food and Drinks</h1>
            <div class="search-container">
                <form method="POST" action="foodAndDrinksUpdateController.php">
                    <label for="fnbID">Input Food and Drinks ID:</label>
                    <input type="number" id="fnbID" name="fnbID" class="clear-input" required>
                    <p></p>
                    ...
                    <br>-->
                    <button type="submit" name="submit">Update FNB</button>
                </form>
            </div>
        </div>
    </section>
